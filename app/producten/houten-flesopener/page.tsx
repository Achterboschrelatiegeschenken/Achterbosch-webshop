...
export default function HoutenFlesopenerPage() {
    const [selectedImage, setSelectedImage] = useState(
  "/products/flesopenerhout.JPG"
)
  return (
    <>
      <Header />
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div
  onClick={() =>
    setSelectedImage("/products/flesopenerhout.JPG")
  }
...
>
  ...
  />
             ...
             <div
  onClick={() =>
    setSelectedImage("/products/flesopener-hout-2.jpeg")
  }
  className="bg-card border border-border rounded-xl p-2 cursor-pointer"
>
  <Image
    src="/products/flesopener-hout-2.jpeg"
    alt="Houten Flesopener"
    width={200}
    height={200}
    className="w-full h-auto object-contain rounded-lg"
  />
             ...
             <div
  onClick={() =>
    setSelectedImage("/products/flesopener-hout3.jpeg")
  }
  className="bg-card border border-border rounded-xl p-2 cursor-pointer"
>
  <Image
    src="/products/flesopener-hout3.jpeg"
    alt="Houten Flesopener"
    width={200}
    height={200}
    className="w-full h-auto object-contain rounded-lg"
  />
          ...
          <div>
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-8">
              Luxe houten flesopener met persoonlijke gravering.
              Perfect als relatiegeschenk, cadeau of promotieartikel.
